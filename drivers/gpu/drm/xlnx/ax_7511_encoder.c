...
static int digilent_hdmi_get_modes(struct drm_connector *connector)
{
	...
	if (hdmi->i2c_bus) {
      		ax_writebyte_8b(hdmi->i2c_bus, TX_SLV0, 0xc9, 0x03);
      		ax_writebyte_8b(hdmi->i2c_bus, TX_SLV0, 0xc9, 0x13);
      		msleep(200);	
...
static int digilent_hdmi_parse_dt(struct digilent_hdmi *hdmi)
{
	...
	if (i2c_node) {
			...
			dev_info(dev, "adv7511 chip version is %x\n",ax_readbyte_8b(hdmi->i2c_bus , TX_SLV0,0));
			ax_writebyte_8b(hdmi->i2c_bus,  TX_SLV0, 0xF3, 0x09);
			ax_writebyte_8b(hdmi->i2c_bus , TX_SLV0, 0x41, 0x00);   //16'h4110; 	
			ax_writebyte_8b(hdmi->i2c_bus , TX_SLV0, 0x98, 0x03);
			ax_writebyte_8b(hdmi->i2c_bus , TX_SLV0, 0x9a, 0xe0);	
			ax_writebyte_8b(hdmi->i2c_bus , TX_SLV0, 0x9c, 0x30);	
			ax_writebyte_8b(hdmi->i2c_bus , TX_SLV0, 0x9d, 0x61);	
			ax_writebyte_8b(hdmi->i2c_bus , TX_SLV0, 0xa2, 0xa4);	
			ax_writebyte_8b(hdmi->i2c_bus , TX_SLV0, 0xa3, 0xa4);	
			ax_writebyte_8b(hdmi->i2c_bus , TX_SLV0, 0xe0, 0xd0);	
			ax_writebyte_8b(hdmi->i2c_bus , TX_SLV0, 0x55, 0x12);	
			ax_writebyte_8b(hdmi->i2c_bus , TX_SLV0, 0xf9, 0x00);
			ax_writebyte_8b(hdmi->i2c_bus , TX_SLV0, 0x43, 0xa0);
			ax_writebyte_8b(hdmi->i2c_bus , TX_SLV0, 0x15, 0x00);  //input id = 0x0 = 0000 = 24 bit RGB 4:4:4 or YCbCr 4:4:4 (separate syncs)
			ax_writebyte_8b(hdmi->i2c_bus , TX_SLV0, 0xd0, 0x3c);
			ax_writebyte_8b(hdmi->i2c_bus , TX_SLV0, 0xaf, 0x04);	
			ax_writebyte_8b(hdmi->i2c_bus , TX_SLV0, 0x4c, 0x04);	
			ax_writebyte_8b(hdmi->i2c_bus , TX_SLV0, 0x40, 0x00);
			ax_writebyte_8b(hdmi->i2c_bus , TX_SLV0, 0xd6, 0xc0);						
